...
import { deleteActivity, fetchActivities, fetchActivity } from "@/services/activityService";
...
export const useActivityStore = defineStore('activity', function() {
    ...
    return { activities, isLoading, getActivities, sortByDay, getActivity, destroyActivity }
})
